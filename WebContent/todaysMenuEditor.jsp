								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
									<div class="offer-item">
										...
										<label class="check-container">
											<input type="checkbox" <% if(food.isAvailableToday(a.getInt("itemCode"))) out.print("checked='checked'"); %> >
        ...
        <!-- end container -->
         <div id="reservation" class="reservations-main pad-top-100 pad-bottom-100">
            <div class="reserve-book-btn text-center">
                <button class="hvr-underline-from-center" type="submit" value="SEND" id="submit">UPDATE TODAY'S MENU </button>
            </div>
            <!-- end container -->
        </div>
